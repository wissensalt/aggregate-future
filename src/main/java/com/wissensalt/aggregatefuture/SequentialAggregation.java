...
public class SequentialAggregation {
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        long start = System.currentTimeMillis();
        CompletableFuture<AllContents> completableFuture = completableFutureContentA()
                .thenCompose(SequentialAggregation::completableFutureContentB)
                .thenCompose(SequentialAggregation::completableFutureContentC);
